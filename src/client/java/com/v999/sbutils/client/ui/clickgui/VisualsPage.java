...
public class VisualsPage extends AbstractPage {
    public VisualsPage(Minecraft client) {
        super(client, new ListView<>(List.of(
                ...
                new ModuleItemView(client, "Dropped item glow filters", "Only glow dropped items that match your filter list. Filters can be names, id:ITEM_ID, name:text, or rarity:legendary.", ConfigManager.FEATURES.DROPPED_ITEM_GLOW_ONLY_MATCHING, newValue -> {
                    ConfigManager.FEATURES.DROPPED_ITEM_GLOW_ONLY_MATCHING = newValue;
                    ConfigManager.FEATURES.markAsChanged();
                }),
                ...
                new ModuleItemView(client, "Open sound folder", "Open config/Sbutils to replace rng_music.ogg or user_music.ogg.",
                        SoundAssetManager::openSoundFolder),
                ...
                new ModuleItemView(client, "Performance HUD - Graph", "Show a tiny live graph below the performance readout.", ConfigManager.FEATURES.PERFORMANCE_HUD_GRAPH_ENABLED, newValue -> {
                    ConfigManager.FEATURES.PERFORMANCE_HUD_GRAPH_ENABLED = newValue;
                    ConfigManager.FEATURES.markAsChanged();
                }),
                new ModuleItemView(client, "Performance HUD - Graph metric",
                        () -> "Current: " + com.v999.sbutils.client.ui.hud.PerformanceHud.graphMetricDisplayName() + ". Click to cycle FPS / ping / TPS.",
                        com.v999.sbutils.client.ui.hud.PerformanceHud::cycleGraphMetric),
