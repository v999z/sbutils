# Speed Dial
The documentation is currently in the works, not finished yet.
...
However, you can change the order afterwards. Go to config/Sbutils/contacts.json and then you can change the order by modifying it.
